    ...
    for i in range(len(question_ids)):
        if type(answers[i]) is list:
            for j in range(len(answers[i])):
                print(f"questionid={question_ids[i]}, answer = {answers[i][j]}")
            ...
            print(f"questionid={question_ids[i]}, answer = {answers[i]}")
